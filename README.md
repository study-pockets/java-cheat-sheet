...
3. [JDK vs JVM vs JRE](#jdk-vs-jvm-vs-jre)
4. [ClassLoader](#classloader)
5. [First Java Program](#first-java-program)
6. [Using Java and JavaC](#using-java-and-javac)
7. [Variables](#variables)
8. [Identifiers](#identifiers)
9. [Java Keywords](#java-keywords)
10. [Literals](#literals)
11. [Tip - Assignment Operator](#tip-assignment-operator)
12. [Casting -  Implicit and Explicit](#casting-implicit-and-explicit)
13. [Other Operators](#other-operators)
14. [Passing Variables to Methods](#passing-variables-to-methods)
15. [Types of Variables](#types-of-variables)
16. [Scope of a Variable](#scope-of-a-variable)
17. [Variable Initialization](#variable-initialization)
18. [Wrapper Classes](#wrapper-classes)
19. [String Class](#string-class)
20. [Bitwise operators](#bitwise-operators)
21. [Logical Operators](#logical-operators)
22. [Arrays](#arrays)
23. [If Else Condition](#if-else-condition)
